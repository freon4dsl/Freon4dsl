...
var sourcePath = path.join(__dirname, './projectit-demo/src');
...
module.exports = {
  ...
  resolve: {
   ...
   alias: {
     "projectit": __dirname + "/projectit/src",
     "projectit-model": __dirname + "/projectit-model/src",
     "projectit-demo": __dirname + "/projectit-demo/src"
    },
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: '../../projectit-demo/src/application/assets/index.html'
    })
  ],
  devServer: {
