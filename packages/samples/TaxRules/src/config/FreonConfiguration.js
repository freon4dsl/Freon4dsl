...
var FreonConfiguration = /** @class */ (function () {
    function FreonConfiguration() {
        ...
        this.customProjection = [new editor_1.CustomRevenueServiceProjection()];
        // add your custom editor actions here
        this.customActions = [new editor_1.CustomRevenueServiceActions()];
        // add your custom validations here
        this.customValidations = [new validator_1.CustomRevenueServiceValidator()];
        // add your custom scopers here
        this.customScopers = [new scoper_1.CustomRevenueServiceScoper()];
        // add your custom type-providers here
        this.customTypers = [new typer_1.CustomRevenueServiceTyperPart()];
        // add extra predefined instances here
        this.customStdLibs = [new stdlib_1.CustomRevenueServiceStdlib()];
    }
