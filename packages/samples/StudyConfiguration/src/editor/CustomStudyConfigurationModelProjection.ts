...
import { FreNode, Box, GridCellBox, LabelBox, IconBox, GridBox, createDefaultExpressionBox, ActionBox, FreLanguage,
    ...
    HorizontalListBox, FreProjection, FreProjectionHandler, FreTableDefinition, TableRowBox, HorizontalLayoutBox, MultiLineTextBox, MultiLineTextBox2, BoxFactory, BoxUtil, BoolDisplay
} from "@freon4dsl/core";
