...
var FreonConfiguration = /** @class */ (function () {
    function FreonConfiguration() {
        ...
        this.customProjection = [new editor_1.CustomStudyConfigurationModelProjection()];
        // add your custom editor actions here
        this.customActions = [new editor_1.CustomStudyConfigurationModelActions()];
        // add your custom validations here
        this.customValidations = [new validator_1.CustomStudyConfigurationModelValidator()];
        // add your custom scopers here
        this.customScopers = [new scoper_1.CustomStudyConfigurationModelScoper()];
        // add your custom type-providers here
        this.customTypers = [new typer_1.CustomStudyConfigurationModelTyperPart()];
        // add extra predefined instances here
        this.customStdLibs = [new stdlib_1.CustomStudyConfigurationModelStdlib()];
    }
