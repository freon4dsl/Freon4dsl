...
/**
 * Class CustomExternalModelActions provides an entry point for the language engineer to
 ...
 */
export class CustomExternalModelActions implements FreCombinedActions {
