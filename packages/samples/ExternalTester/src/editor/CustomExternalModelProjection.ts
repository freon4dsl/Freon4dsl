...
/**
 * Class CustomExternalModelProjection provides an entry point for the language engineer to
 ...
 */
export class CustomExternalModelProjection implements FreProjection {
    name: string = "Custom";
