...
exports.CustomPiLanguageProjection = void 0;
/**
 * Class CustomPiLanguageProjection provides an entry point for the language engineer to
 ...
 */
var CustomPiLanguageProjection = /** @class */ (function () {
    function CustomPiLanguageProjection() {
        this.name = "Manual";
    ...
    return CustomPiLanguageProjection;
}());
exports.CustomPiLanguageProjection = CustomPiLanguageProjection;
