...
/**
 * Class CustomDocuProjectProjection provides an entry point for the language engineer to
 ...
 */
export class CustomDocuProjectProjection implements PiProjection {
