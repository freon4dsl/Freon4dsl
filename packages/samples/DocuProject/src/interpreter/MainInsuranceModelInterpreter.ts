...
import { InsuranceModelInterpreterInit } from "./gen/InsuranceModelInterpreterInit";
 ...
 */
export class MainInsuranceModelInterpreter implements FreInterpreter {
    private static main: IMainInterpreter = null;

    constructor() {
        if (MainInsuranceModelInterpreter.main === null) {
            MainInsuranceModelInterpreter.main = MainInterpreter.instance(
                InsuranceModelInterpreterInit,
                getConceptFunction,
                getPropertyFunction,
            );
        }
    ...
    evaluate(node: Object): RtObject {
        ...
        try {
            return MainInsuranceModelInterpreter.main.evaluate(node, InterpreterContext.EMPTY_CONTEXT);
        } catch (e: any) {
