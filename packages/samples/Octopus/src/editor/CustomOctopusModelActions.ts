...
/**
 * Class CustomOctopusModelActions provides an entry point for the language engineer to
 ...
 */
export class CustomOctopusModelActions implements FreCombinedActions {
