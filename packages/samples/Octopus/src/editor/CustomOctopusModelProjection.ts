...
/**
 * Class CustomOctopusModelProjection provides an entry point for the language engineer to
 ...
 */
export class CustomOctopusModelProjection implements FreProjection {
    name: string = "Manual";
