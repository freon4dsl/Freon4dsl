...
import { PiElement, PiType, PiTyper, PiTyperPart } from "@freon4dsl/core";
import { RulesLanguageTyper } from "../typer/gen/RulesLanguageTyper";

/**
 * Class 'CustomRulesLanguageTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomRulesLanguageTyperPart implements PiTyperPart {
    mainTyper: RulesLanguageTyper;
