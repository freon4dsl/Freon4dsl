...
import { FreNode, Box, FreProjectionHandler, FreProjection, FreTableDefinition } from "@freon4dsl/core";

/**
 * Class CustomRulesModelProjection provides an entry point for the language engineer to
 ...
 */
export class CustomRulesModelProjection implements FreProjection {
    name: string = "Manual";
