...
/**
 * Class CustomEntityModelActions provides an entry point for the language engineer to
 ...
 */
export class CustomEntityModelActions implements FreCombinedActions {
