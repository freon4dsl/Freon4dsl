...
import { FreLanguageXInterpreterInit } from "./gen/FreLanguageXInterpreterInit.js";
 ...
 */
export class MainFreLanguageXInterpreter implements FreInterpreter {
    private static main: IMainInterpreter = null;

    constructor() {
        if (MainFreLanguageXInterpreter.main === null) {
            MainFreLanguageXInterpreter.main = MainInterpreter.instance(
                FreLanguageXInterpreterInit,
                getConceptFunction,
                getPropertyFunction,
            );
        }
    ...
    setTracing(value: boolean) {
        MainFreLanguageXInterpreter.main.setTracing(value);
    }

    getTrace(): InterpreterTracer {
        return MainFreLanguageXInterpreter.main.getTrace();
    }
    ...
    evaluateWithContext(node: Object, ctx: InterpreterContext): RtObject {
        MainFreLanguageXInterpreter.main.reset();
        try {
            return MainFreLanguageXInterpreter.main.evaluate(node, ctx);
        } catch (e: any) {
