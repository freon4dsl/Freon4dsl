...
/**
 * Class CustomFreLanguageXProjection provides an entry point for the language engineer to
 ...
 */
export class CustomFreLanguageXProjection implements FreProjection {
    name: string = "Custom";
