...
/**
 * Class CustomFreLanguageXActions provides an entry point for the language engineer to
 ...
 */
export class CustomFreLanguageXActions implements FreCombinedActions {
