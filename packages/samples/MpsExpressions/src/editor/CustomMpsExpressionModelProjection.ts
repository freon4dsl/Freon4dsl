...
/**
 * Class CustomMpsExpressionModelProjection provides an entry point for the language engineer to
 ...
 */
export class CustomMpsExpressionModelProjection implements FreProjection {
    name: string = "Manual";
