...
/**
 * Class CustomCourseScheduleProjection provides an entry point for the language engineer to
 ...
 */
export class CustomCourseScheduleProjection implements FreProjection {
    name: string = "Custom";
