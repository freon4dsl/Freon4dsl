...
/**
 * Class CustomCourseScheduleActions provides an entry point for the language engineer to
 ...
 */
export class CustomCourseScheduleActions implements FreCombinedActions {
