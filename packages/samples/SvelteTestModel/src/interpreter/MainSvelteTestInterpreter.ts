...
import { SvelteTestInterpreterInit } from "./gen/SvelteTestInterpreterInit.js";
 ...
 */
export class MainSvelteTestInterpreter implements FreInterpreter {
    private static main: IMainInterpreter = null;

    constructor() {
        if (MainSvelteTestInterpreter.main === null) {
            MainSvelteTestInterpreter.main = MainInterpreter.instance(SvelteTestInterpreterInit, getConceptFunction, getPropertyFunction);
        }
    }

    setTracing(value: boolean) {
        MainSvelteTestInterpreter.main.setTracing(value);
    }

    getTrace(): InterpreterTracer {
        return MainSvelteTestInterpreter.main.getTrace();
    }
    ...
    evaluateWithContext(node: Object, ctx: InterpreterContext): RtObject {
        MainSvelteTestInterpreter.main.reset();
        try {
            return MainSvelteTestInterpreter.main.evaluate(node, ctx);
        } catch (e: any) {
