...
/**
 * Class CustomCalculatorModelProjection provides an entry point for the language engineer to
 ...
 */
export class CustomCalculatorModelProjection implements FreProjection {
    name: string = "Manual";
