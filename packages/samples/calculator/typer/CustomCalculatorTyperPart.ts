...
import { CalculatorTyper } from "../typer/gen/CalculatorTyper";

/**
 * Class 'CustomCalculatorTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomCalculatorTyperPart implements PiTyperPart {
    mainTyper: CalculatorTyper;
