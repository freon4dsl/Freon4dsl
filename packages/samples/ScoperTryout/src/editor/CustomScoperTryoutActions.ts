...
/**
 * Class CustomScoperTryoutActions provides an entry point for the language engineer to
 ...
 */
export class CustomScoperTryoutActions implements FreCombinedActions {
