...
/**
 * Class CustomScoperTryoutProjection provides an entry point for the language engineer to
 ...
 */
export class CustomScoperTryoutProjection implements FreProjection {
    name: string = "Custom";
