...
/**
 * Class CustomFreTyperModelProjection provides an entry point for the language engineer to
 ...
 */
export class CustomFreTyperModelProjection implements FreProjection {
    name: string = "Custom";
