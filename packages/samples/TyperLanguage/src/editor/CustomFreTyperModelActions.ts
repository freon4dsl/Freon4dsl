...
/**
 * Class CustomFreTyperModelActions provides an entry point for the language engineer to
 ...
 */
export class CustomFreTyperModelActions implements FreCombinedActions {
