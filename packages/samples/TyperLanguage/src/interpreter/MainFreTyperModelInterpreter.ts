...
import { FreTyperModelInterpreterInit } from "./gen/FreTyperModelInterpreterInit.js";
 ...
 */
export class MainFreTyperModelInterpreter implements FreInterpreter {
    private static main: IMainInterpreter = null;

    constructor() {
        if (MainFreTyperModelInterpreter.main === null) {
            MainFreTyperModelInterpreter.main = MainInterpreter.instance(
                FreTyperModelInterpreterInit,
                getConceptFunction,
                getPropertyFunction,
            );
        }
    ...
    setTracing(value: boolean) {
        MainFreTyperModelInterpreter.main.setTracing(value);
    }

    getTrace(): InterpreterTracer {
        return MainFreTyperModelInterpreter.main.getTrace();
    }
    ...
    evaluateWithContext(node: Object, ctx: InterpreterContext): RtObject {
        MainFreTyperModelInterpreter.main.reset();
        try {
            return MainFreTyperModelInterpreter.main.evaluate(node, ctx);
        } catch (e: any) {
