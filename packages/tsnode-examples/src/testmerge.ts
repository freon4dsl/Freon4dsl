...
import {
    ...
    FreMetaParameter,
} from "@freon4dsl/meta/dist/languagedef/metalanguage/index";

function one(o: Object) {
    // if( o instanceof TextBox) { console.log("TEXTBOX 2");return; }
    if (o instanceof SvgBox) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof LabelBox) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof GridBox) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof GridCellBox) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof HorizontalListBox) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof VerticalListBox) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof FreUtils) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof FreAction) {
        console.log("TEXTBOX 2");
        return;
    }
    // if( o instanceof FreActionsUtil) { console.log("TEXTBOX 2");return; }
    if (o instanceof FreMetaClassifier) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof FreMetaParameter) {
        console.log("TEXTBOX 2");
        return;
    }
    // if( o instanceof FreCompositeProjection) { console.log("TEXTBOX 2");return; }
    if (o instanceof FreCommand) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof FreMetaConceptProperty) {
        console.log("TEXTBOX 2");
        return;
    }
    if (o instanceof FreCustomCommand) {
        console.log("TEXTBOX 2");
        return;
    }
...
function two(o: Object) {
    switch (o.constructor) {
        ...
        case FreMetaClassifier:
            console.log("OscillatorNode");
            return;
        case FreMetaParameter:
            console.log("OscillatorNode");
            return;
        ...
        case FreCommand:
            console.log("OscillatorNode");
            return;
        case FreMetaConceptProperty:
            console.log("OscillatorNode");
            return;
        case FreCustomCommand:
            console.log("OscillatorNode");
            return;
        case TextBox:
