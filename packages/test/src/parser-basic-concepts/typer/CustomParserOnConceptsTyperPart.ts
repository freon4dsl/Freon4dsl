...
import { ParserOnConceptsTyper } from "../typer/gen/ParserOnConceptsTyper";

/**
 * Class 'CustomParserOnConceptsTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomParserOnConceptsTyperPart implements PiTyperPart {
    mainTyper: ParserOnConceptsTyper;
