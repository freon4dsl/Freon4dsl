...
/**
 * Class CustomParserOnConceptsActions provides an entry point for the language engineer to
 ...
 */
export class CustomParserOnConceptsActions implements PiActions {
