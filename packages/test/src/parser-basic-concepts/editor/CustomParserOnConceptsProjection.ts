...
/**
 * Class CustomParserOnConceptsProjection provides an entry point for the language engineer to
 ...
 */
export class CustomParserOnConceptsProjection implements PiProjection {
