...
import { OctopusTyper } from "../typer/gen/OctopusTyper";

/**
 * Class 'CustomOctopusTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomOctopusTyperPart implements PiTyperPart {
    mainTyper: OctopusTyper;
