...
import { TestCircularImportsTyper } from "../typer/gen/TestCircularImportsTyper";

/**
 * Class 'CustomTestCircularImportsTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomTestCircularImportsTyperPart implements PiTyperPart {
    mainTyper: TestCircularImportsTyper;
