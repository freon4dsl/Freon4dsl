...
/**
 * Class CustomTestCircularImportsProjection provides an entry point for the language engineer to
 ...
 */
export class CustomTestCircularImportsProjection implements PiProjection {
