import { AST, FreNodeReference, type FreNode, FreLanguage } from "@freon4dsl/core";
...
export class DemoModelCreator {
    ...
    public createModelWithIsUniqueError(): Demo {
        ...
        AST.change( () => {
            ...
            const VAT_Number2 = DemoAttribute.create({
                name: "VAT_Number",
                declaredType: FreNodeReference.create<DemoAttributeType>(DemoAttributeType.Integer, "DemoAttributeType"),
            });
            ...
            const extra = DemoVariable.create({
                name: "Extra",
                declaredType: FreNodeReference.create<DemoEntity>(companyEnt, "DemoEntity"),
            });
            const extra2 = DemoVariable.create({
                name: "Extra",
                declaredType: FreNodeReference.create<DemoEntity>(companyEnt, "DemoEntity"),
            }); // another one with the same name
    ...
    private createInheritanceUnit() {
        ...
        AST.change( () => {
            ...
            const brand = DemoAttribute.create({
                name: "brand",
                declaredType: FreNodeReference.create<DemoAttributeType>("String", "DemoAttributeType"),
            });
            const vehicleName = DemoAttribute.create({
                name: "type",
                declaredType: FreNodeReference.create<DemoAttributeType>("String", "DemoAttributeType"),
            });
            ...
            const numberplate = DemoAttribute.create({
                name: "numberplate",
                declaredType: FreNodeReference.create<DemoAttributeType>("Integer", "DemoAttributeType"),
            });
            const carType = DemoAttribute.create({
                name: "make",
                declaredType: FreNodeReference.create<DemoAttributeType>("String", "DemoAttributeType"),
            });
            ...
            const backseat = DemoAttribute.create({
                name: "backseat",
                declaredType: FreNodeReference.create<DemoAttributeType>("Boolean", "DemoAttributeType"),
            });
            const gears = DemoAttribute.create({
                name: "gears",
                declaredType: FreNodeReference.create<DemoAttributeType>("Integer", "DemoAttributeType"),
            });
            ...
            const color = DemoAttribute.create({
                name: "color",
                declaredType: FreNodeReference.create<DemoAttributeType>("String", "DemoAttributeType"),
            });
            const wheelsize = DemoAttribute.create({
                name: "wheelsize",
                declaredType: FreNodeReference.create<DemoAttributeType>("Integer", "DemoAttributeType"),
            });
    ...
    public createIncorrectModel(): Demo {
        ...
        AST.change( () => {
            ...
            funcWithManyParams.declaredType = FreNodeReference.create<DemoAttributeType>(
                DemoAttributeType.Integer,
                "DemoAttributeType",
            );
            ...
            length.declaredType = FreNodeReference.create<DemoAttributeType>(
                DemoAttributeType.Integer,
                "DemoAttributeType",
            );
            ...
            determine.declaredType = FreNodeReference.create<DemoAttributeType>(
                DemoAttributeType.Integer,
                "DemoAttributeType",
            );
    ...
    private createCorrectUnit() {
        ...
        AST.change( () => {
            ...
            helloFunction.declaredType = FreNodeReference.create<DemoAttributeType>(
            ...
            const VAT_Number = DemoAttribute.create({ name: "VAT_Number" });
            VAT_Number.declaredType = FreNodeReference.create<DemoAttributeType>(
                DemoAttributeType.Integer,
                "DemoAttributeType",
            );
            companyEnt.attributes.push(companyName);
            ...
            founded.declaredType = FreNodeReference.create<DemoAttributeType>(
                DemoAttributeType.Integer,
                "DemoAttributeType",
            );
            const schoolName = DemoAttribute.create({ name: "name" });
            schoolName.declaredType = FreNodeReference.create<DemoAttributeType>(
                DemoAttributeType.String,
                "DemoAttributeType",
            );
