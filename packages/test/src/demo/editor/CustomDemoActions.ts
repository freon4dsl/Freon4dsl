...
import { PiCreateBinaryExpressionAction, PiCustomAction, PiCompositeActions } from "@projectit/core";
 ...
 */
export class CustomDemoActions implements PiCompositeActions {
