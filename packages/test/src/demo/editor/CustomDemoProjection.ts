...
import { PiProjection, PiElement, Box, createDefaultExpressionBox, KeyPressAction, TextBox } from "@projectit/core";
import { projectitStyles } from "../editor/styles/styles";
