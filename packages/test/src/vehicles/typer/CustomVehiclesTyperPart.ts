...
import { VehiclesTyper } from "../typer/gen/VehiclesTyper";

/**
 * Class 'CustomVehiclesTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomVehiclesTyperPart implements PiTyperPart {
    mainTyper: VehiclesTyper;
