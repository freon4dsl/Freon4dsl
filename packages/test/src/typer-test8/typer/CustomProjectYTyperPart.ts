...
import { ProjectYTyper } from "../typer/gen/ProjectYTyper";

/**
 * Class 'CustomProjectYTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomProjectYTyperPart implements PiTyperPart {
    mainTyper: ProjectYTyper;
