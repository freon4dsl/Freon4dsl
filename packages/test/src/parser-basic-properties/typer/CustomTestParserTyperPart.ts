...
import { TestParserTyper } from "../typer/gen/TestParserTyper";

/**
 * Class 'CustomTestParserTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomTestParserTyperPart implements PiTyperPart {
    mainTyper: TestParserTyper;
