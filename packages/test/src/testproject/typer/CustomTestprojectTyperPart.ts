...
import { TestprojectTyper } from "../typer/gen/TestprojectTyper";

/**
 * Class 'CustomTestprojectTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomTestprojectTyperPart implements PiTyperPart {
    mainTyper: TestprojectTyper;
