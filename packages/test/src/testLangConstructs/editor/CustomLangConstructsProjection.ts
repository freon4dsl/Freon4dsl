...
/**
 * Class CustomLangConstructsProjection provides an entry point for the language engineer to
 ...
 */
export class CustomLangConstructsProjection implements PiProjection {
