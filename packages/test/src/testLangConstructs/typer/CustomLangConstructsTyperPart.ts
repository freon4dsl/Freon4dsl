...
import { LangConstructsTyper } from "../typer/gen/LangConstructsTyper";

/**
 * Class 'CustomLangConstructsTyperPart' is meant to be a convient place to add any
 * custom code for type checking.
 */
export class CustomLangConstructsTyperPart implements PiTyperPart {
    mainTyper: LangConstructsTyper;
