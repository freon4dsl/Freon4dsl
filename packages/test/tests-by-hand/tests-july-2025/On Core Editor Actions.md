...
On Mac _Ctrl-arrow-up_ should be _Option-arrow-up_.
...
|:-----|:---------------------------------------------------------- |:-----------------------------------------------------------------------------------------|
|      | Open language Education, model Edu-test, unit Fractions101 | selected element: box: Topic-main-referencebox BOX-4 elem: ID-8 - Topic  "NotTextBox"    |
|      | Select the 12 in _marbles2_                                | selected element: box: Fraction-hlist-line-0 BOX-77 elem: ID-31 - Fraction  "12"         |
|      | Type _ctrl-arrow-up_                                       | selected element: box: Fraction-hlist-line-0 BOX-77 elem: ID-31 - Fraction  "NotTextBox" |
...
|      | Repeat behavior as you like, save unit to be sure the changes are persisted | changes in various lists                                          |
|      | Drag _gradeF_ to _gradeB_ in the same table.                                | _gradeF_ is moved                                              |
| DONE |                                                            |                                                                                                   |
