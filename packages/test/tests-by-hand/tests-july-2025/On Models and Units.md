...
| Type name _<NAME>_, and choose _New_               | The editor shows a message: 'Please, select, create ...', and the previous model is saved. |
...
### Scenario 2: rename unit from model panel => not yet implemented
Pre: A model is present.
