...
| Select first question from _Practice1_ (_lollipops1_), choose _Paste_   | The question appears below (_lollipops1_)                              |
| Select placeholder for questions from _Practice1_, type _Ctlr-v_        | The question appears above the placeholder (Not functioning in v1.1.0) |
| Select a line of content from _Theory101_, type _Ctlr-c_                | Message: text is copied to clipboard                                   |
| Select content from _Example1_, choose _Paste_                          | The text appears above the placeholder                                 |
| Select Score>GradeA from _Theory101_, type _Ctlr-x_                     | The Grade disappears                                                   |
| Select Score>GradeA from _Practice1_, choose _Paste_                    | The Grade appears above the placeholder                                |
