...
:b: row is never really selected and does look weird when several cells are selected.

:b: Also after deletion of a row the cursor in the editor is gone, it should probably go to another row in the table (if available)
