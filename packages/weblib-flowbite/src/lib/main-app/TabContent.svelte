...
<div class="flex w-auto h-full grid-rows-[auto,1fr] col-span-2 ">
	{#if infoPanelShown.value}
		<div class="flex-grow-1 h-[80vh] w-[70vw] relative top-0 overflow-y-auto border-1">
			<EditorPart />
		</div>
		<div
			class="flex-grow-1 h-[80vh] w-[30vw] relative top-0 overflow-y-auto border-1 max-w-[40rem]
	...
	{:else}
		<div class="flex-grow-1 h-[80vh] w-full relative top-0 overflow-y-auto border-1 ">
			<EditorPart />
		</div>
	{/if}
</div>
