<script lang="ts">
    import { noUnitAvailable, userMessageOpen } from "../stores/index.js"
...
<div id="editor-part" class='box-border bg-light-base-50 dark:bg-dark-base-900 dark:text-dark-base-50 p-1'>
