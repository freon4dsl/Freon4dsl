...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { Scoper_Definition: peg$parseScoper_Definition };
  var peg$startRuleFunction = peg$parseScoper_Definition;

  var peg$c0 = "scoper";
  var peg$c1 = "for";
  var peg$c2 = "language";
  var peg$c3 = "isnamespace";
  var peg$c4 = "namespace_addition";
  var peg$c5 = "scope";
  var peg$c6 = ":";
  var peg$c7 = ".";
  var peg$c8 = "{";
  ...
  var peg$e0 = peg$literalExpectation("scoper", false);
  var peg$e1 = peg$literalExpectation("for", false);
  var peg$e2 = peg$literalExpectation("language", false);
  var peg$e3 = peg$literalExpectation("isnamespace", false);
  var peg$e4 = peg$literalExpectation("namespace_addition", false);
  var peg$e5 = peg$literalExpectation("scope", false);
  ...
  var peg$e18 = peg$otherExpectation("required whitespace");
  var peg$e19 = peg$otherExpectation("variable");
  ...
  var peg$e39 = peg$classExpectation([["0", "9"], ["a", "f"]], false, false);

  var peg$f0 = function(scoperName, languageName, ns, defs) {
  ...
  var peg$f1 = function(head, v) { return v; };
  var peg$f2 = function(head, tail) { return [head].concat(tail); };
  var peg$f3 = function(conceptRefs) { 
        return conceptRefs;
    };
  var peg$f4 = function(name, nsDef, alternativeScope) {
  ...
  var peg$f5 = function(list) {
        return create.createNamespaceDef({ "expressions": list, "location":location() });
    };
  var peg$f6 = function(head, v) { return v; };
  var peg$f7 = function(head, tail) { return [head].concat(tail); };
  ...
  var peg$f9 = function(referredName) {
    return expCreate.createClassifierReference({"name": referredName, "location": location()})
};
  var peg$f10 = function(functionExpression) { return functionExpression; };
  var peg$f11 = function(instanceExpression) { return instanceExpression; };
  var peg$f12 = function(expression) { return expression; };
  var peg$f13 = function(simpleExpression) { return simpleExpression; };
  var peg$f14 = function(conceptName, instance) {
  ...
  var peg$f15 = function(sourceName, appliedfeature) {
  ...
  var peg$f16 = function(sourceName) {
                return expCreate.createExpression ({
                    "sourceName": sourceName,
                    "location": location()
                })
            };
  var peg$f17 = function(sourceName, appliedfeature) {
...
( {
  ...
  var peg$f18 = function(sourceName, head, v) { return v; };
  var peg$f19 = function(sourceName, head, tail) { return [head].concat(tail); };
  var peg$f20 = function(sourceName, actualparams, appliedfeature) {
...
( {
  ...
  var peg$f22 = function(first, rest) { return first + rest.join(""); };
  var peg$f23 = function(chars) { return chars.join(""); };
  var peg$f24 = function(nums) { return nums.join(""); };
      ...
      if (s4 !== peg$FAILED) {
        ...
        if (s6 !== peg$FAILED) {
          ...
          if (s8 !== peg$FAILED) {
            ...
            if (s10 !== peg$FAILED) {
              s11 = peg$parsews();
              s12 = peg$parsenamespaces();
              if (s12 !== peg$FAILED) {
                s13 = [];
                s14 = peg$parseconceptDefinition();
                while (s14 !== peg$FAILED) {
                  s13.push(s14);
                  s14 = peg$parseconceptDefinition();
                }
                peg$savedPos = s0;
                s0 = peg$f0(s4, s10, s12, s13);
              } else {
                peg$currPos = s0;
                s0 = peg$FAILED;
              }
  ...
  function peg$parseisnamespaceKey() {
    var s0, s1, s2;
  ...
  function peg$parsealternativeScopeKey() {
    var s0, s1, s2;
  ...
  function peg$parsenamespaces() {
    var s0, s1, s2, s3, s4, s5, s6, s7, s8;

    s0 = peg$currPos;
    s1 = peg$parseisnamespaceKey();
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s4 !== peg$FAILED) {
          ...
          if (s7 !== peg$FAILED) {
            s8 = peg$parseclassifierReference();
            if (s8 !== peg$FAILED) {
              peg$savedPos = s6;
              s6 = peg$f1(s4, s8);
            } else {
  ...
  function peg$parseconceptDefinition() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parsecurly_begin();
      if (s2 !== peg$FAILED) {
        s3 = peg$parsenamespaceAddition();
        if (s3 === peg$FAILED) {
          s3 = null;
        }
        s4 = peg$parsealternativeScope();
        if (s4 === peg$FAILED) {
          s4 = null;
        }
        s5 = peg$parsecurly_end();
  ...
  function peg$parsenamespaceAddition() {
    var s0, s1, s2, s3, s4;

    s0 = peg$currPos;
    s1 = peg$parseadditionKey();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseequals_separator();
      if (s2 !== peg$FAILED) {
        s3 = peg$parseexpressionlist();
        if (s3 !== peg$FAILED) {
          s4 = peg$parsesemicolon_separator();
          if (s4 !== peg$FAILED) {
            peg$savedPos = s0;
            s0 = peg$f5(s3);
          } else {
  ...
  function peg$parsealternativeScope() {
    var s0, s1, s2, s3, s4;

    s0 = peg$currPos;
    s1 = peg$parsealternativeScopeKey();
    if (s1 !== peg$FAILED) {
      s2 = peg$parseequals_separator();
      if (s2 !== peg$FAILED) {
        s3 = peg$parselangExpression();
        if (s3 !== peg$FAILED) {
          s4 = peg$parsesemicolon_separator();
          if (s4 !== peg$FAILED) {
            peg$savedPos = s0;
