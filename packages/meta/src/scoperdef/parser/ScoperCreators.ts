import { PiLangPrimitiveProperty, PiLangConcept, PiLangElementProperty, PiLanguage, PiLangEnumeration, PiLangConceptReference } from "../../languagedef/metalanguage/PiLanguage";
