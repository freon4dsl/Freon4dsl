...
export class Helpers {
    ...
    public static pretty(typescriptFile: string, message: string, numberOfErrors: number): string {
        try {
            ...
            console.log("FOUT FOUT " + numberOfErrors);
     ...
     */
    public static deleteFilesInDir(dir: string, numberOfErrors: number) {
     ...
     */
    public static findFiles(startPath: string, numberOfErrors: number, extension?: string, ): string[] {
