...
export class Names {
    ...
    static FreScoper: string = "Scoper"
    static FreScoperBase: string = "ScoperBase"
    static FreCompositeScoper: string = "CompositeScoper"
    static FreNamespace: string = "Namespace"
    static FreNamespaceInfo: string = "NamespaceInfo"
    ...
    static CoreConfig: string = "CoreConfig"
    ...
    static unitAnalyser(language: FreMetaLanguage, unit: FreMetaUnitDescription | FreMetaModelDescription | undefined): string {
        if (!!unit) {
