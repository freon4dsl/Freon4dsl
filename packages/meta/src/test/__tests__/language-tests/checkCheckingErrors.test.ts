...
describe("Checking language parser on checking errors", () => {
    ...
    test("language should have no more than one model concept and concepts and properties should have unique names", () => {
        ...
        try {
            ...
            expect(checker.errors.includes("The model should have a 'name' property [file: test2.ast, line: 3, column: 1].")).toBeTruthy();
    ...
    test("checking limitations on inheritance and implemented interfaces", () => {
        ...
        try {
            ...
            expect(checker.errors.includes("The model should have a 'name' property [file: test3.ast, line: 3, column: 1].")).toBeTruthy();
            ...
            expect(checker.errors.includes("A non-abstract limited concept must have instances [file: test3.ast, line: 18, column: 1].")).toBeTruthy();
            ...
            expect(checker.errors.includes("Concept 'ZZ' is not an interface [file: test3.ast, line: 18, column: 23].")).toBeTruthy();
    ...
    test("checking circular inheritance", () => {
        ...
        try {
            ...
            expect(checker.errors.includes("The model should have a 'name' property [file: test4.ast, line: 7, column: 1].")).toBeTruthy();
    ...
    test("checking circular interfaces", () => {
        ...
        try {
            ...
            expect(checker.errors.includes("The model should have a 'name' property [file: test5.ast, line: 3, column: 1].")).toBeTruthy();
    ...
    test("checking expression concepts", () => {
        ...
        try {
            ...
            expect(checker.errors.includes("The model should have a 'name' property [file: test6.ast, line: 3, column: 1].")).toBeTruthy();
    ...
    test("checking limited concepts", () => {
        ...
        try {
            ...
            expect(checker.errors.includes("The model should have a 'name' property [file: test7.ast, line: 3, column: 1].")).toBeTruthy();
    ...
    test("checking limited concepts extended", () => {
        ...
        try {
            ...
            expect(checker.errors.includes("The model should have a 'name' property [file: test8.ast, line: 21, column: 1].")).toBeTruthy();
