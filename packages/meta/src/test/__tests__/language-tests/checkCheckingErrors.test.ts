...
describe("Checking language parser on checking errors", () => {
    ...
    test("checking limited concepts", () => {
        ...
        try {
            ...
            expect(e.message).toBe(`checking errors.`);
            expect(checker.errors.includes("Type 'NoName' cannot be used as a reference, because it has no name property [file: src/test/__tests__/language-tests/faultyDefFiles/checking-errors/test7.lang, line: 4, column: 24].")).toBeTruthy();
            expect(checker.errors.includes("Type 'NameNotStringType' cannot be used as a reference, because its name property is not of type 'string' [file: src/test/__tests__/language-tests/faultyDefFiles/checking-errors/test7.lang, line: 5, column: 25].")).toBeTruthy();
            expect(checker.errors.includes("Property 's' does not exist on concept RRRR [file: src/test/__tests__/language-tests/faultyDefFiles/checking-errors/test7.lang, line: 13, column: 19].")).toBeTruthy();
            expect(checker.errors.includes("Type of 'text' does not equal type of property 'simple' [file: src/test/__tests__/language-tests/faultyDefFiles/checking-errors/test7.lang, line: 14, column: 19].")).toBeTruthy();
            expect(checker.errors.includes("Property 's' does not exist on concept AA [file: src/test/__tests__/language-tests/faultyDefFiles/checking-errors/test7.lang, line: 20, column: 19].")).toBeTruthy();
            expect(checker.errors.includes("Type of 'text' does not equal type of property 'simple' [file: src/test/__tests__/language-tests/faultyDefFiles/checking-errors/test7.lang, line: 21, column: 19].")).toBeTruthy();
            expect(checker.errors.includes("Type of '10' does not equal type of property 'prop2' [file: src/test/__tests__/language-tests/faultyDefFiles/checking-errors/test7.lang, line: 24, column: 19].")).toBeTruthy();
            expect(checker.errors.includes("Instance with name 'instance5' already exists [file: src/test/__tests__/language-tests/faultyDefFiles/checking-errors/test7.lang, line: 25, column: 5].")).toBeTruthy();
        }
    });
