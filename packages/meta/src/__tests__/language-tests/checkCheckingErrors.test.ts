...
describe("Checking language parser on checking errors", () => {
    ...
    test("language should have no more than one model concept and concepts and properties should have unique names", () => {
        try {
            ...
            if (e instanceof Error) {            // checker.errors.forEach(err => console.log(err));
                ...
                expect(checker.errors.includes("There may be only one model in the language definition [file: test2.ast:5:1].")).toBeTruthy();
                expect(checker.errors.includes("Concept or interface with name 'ZZZ' already exists [file: test2.ast:29:1].")).toBeTruthy();
                expect(checker.errors.includes("Concept or interface with name 'YYY' already exists [file: test2.ast:31:1].")).toBeTruthy();
            }
        }
    });
    ...
    test("checking limitations on inheritance and implemented interfaces", () => {
        try {
            ...
            if (e instanceof Error) {            // console.log(checker.errors.map(err => err));
                ...
                expect(checker.errors.includes("The model should have at least one part [file: test3.ast:3:1].")).toBeTruthy();
                expect(checker.errors.includes("Base 'AAA' must be a concept [file: test3.ast:9:18].")).toBeTruthy();
                expect(checker.errors.includes("A non-abstract limited concept must have instances [file: test3.ast:17:1].")).toBeTruthy();
                expect(checker.errors.includes("Limited concept 'AA' cannot be base of an unlimited concept [file: test3.ast:13:16].")).toBeTruthy();
                expect(checker.errors.includes("Concept 'ZZ' is not an interface [file: test3.ast:17:23].")).toBeTruthy();
                expect(checker.errors.includes("A non-abstract limited concept must have instances [file: test3.ast:11:1].")).toBeTruthy();
                expect(checker.errors.includes("A concept may not have an expression as base [file: test3.ast:19:18].")).toBeTruthy();
    ...
    test("checking expression concepts", () => {
        try {
            ...
            if (e instanceof Error) {            // checker.errors.forEach(err => console.log(err));
                ...
                expect(checker.errors.includes("The model should have at least one part [file: test6.ast:3:1].")).toBeTruthy();
                expect(checker.errors.includes("Binary expression concept YYY should have a priority [file: test6.ast:5:1].")).toBeTruthy();
                expect(checker.errors.includes("Binary expression concept YYY should have a left part [file: test6.ast:5:1].")).toBeTruthy();
                expect(checker.errors.includes("Binary expression concept YYY should have a right part [file: test6.ast:5:1].")).toBeTruthy();
            }
        }
    });
    ...
    test("checking limited concepts", () => {
        try {
            ...
            if (e instanceof Error) {            // console.log(checker.errors.map(err => err));
                ...
                expect(checker.errors.includes("The model should have at least one part [file: test7.ast:3:1].")).toBeTruthy();
                expect(checker.errors.includes("All properties of a model must be parts, not references [file: test7.ast:3:1].")).toBeTruthy();
                expect(checker.errors.includes("An abstract limited concept may not have any instances [file: test7.ast:32:1].")).toBeTruthy();
                expect(checker.errors.includes("Property 's' does not exist on concept RRRR [file: test7.ast:13:19].")).toBeTruthy();
                expect(checker.errors.includes("Type of 'text' (string) does not fit type (number) of property 'simple' [file: test7.ast:14:19].")).toBeTruthy();
                expect(checker.errors.includes("Property 's' does not exist on concept AA [file: test7.ast:20:19].")).toBeTruthy();
                expect(checker.errors.includes("Type of 'text' (string) does not fit type (number) of property 'simple' [file: test7.ast:21:19].")).toBeTruthy();
                expect(checker.errors.includes("Type of 'false' (string) does not fit type (boolean) of property 'prop2' [file: test7.ast:23:19].")).toBeTruthy();
                expect(checker.errors.includes("Type of '10' (string) does not fit type (boolean) of property 'prop2' [file: test7.ast:24:19].")).toBeTruthy();
                expect(checker.errors.includes("Instance with name 'instance5' already exists [file: test7.ast:25:5].")).toBeTruthy();
                expect(checker.errors.includes("Type of '10' (string) does not fit type (number) of property 'simple' [file: test7.ast:25:19].")).toBeTruthy();
            }
        }
    });
    ...
    test("checking more limited concepts", () => {
        try {
            ...
            if (e instanceof Error) {            // console.log(checker.errors.map(err => err));
                ...
                expect(checker.errors.includes("Instance with name 'mmInstance1' already exists in the base concept [file: test7a.ast:12:5].")).toBeTruthy();
                expect(checker.errors.includes("Instance with name 'llInstance3' already exists in the base concept [file: test7a.ast:13:5].")).toBeTruthy();
                expect(checker.errors.includes("Instance with name 'kkInstance1' already exists [file: test7a.ast:15:5].")).toBeTruthy();
            }
        }
    });
    ...
    test("checking limited concepts extended", () => {
        try {
            ...
            if (e instanceof Error) {            // checker.errors.forEach(err => console.log(err));
                ...
                expect(checker.errors.includes("The model should have at least one part [file: test8.ast:21:1].")).toBeTruthy();
                expect(checker.errors.includes("Property 'ZZprop7' of limited concept should have primitive type [file: test8.ast:12:5].")).toBeTruthy();
                expect(checker.errors.includes("A non-abstract limited concept must have instances [file: test8.ast:3:1].")).toBeTruthy();
                expect(checker.errors.includes("Property 'ZZprop7' does not exist on concept YY [file: test8.ast:16:21].")).toBeTruthy();
                expect(checker.errors.includes("A limited concept may not inherit or implement non-primitive parts [file: test8.ast:15:1].")).toBeTruthy();
                expect(checker.errors.includes("A limited concept may not inherit or implement non-primitive parts [file: test8.ast:3:1].")).toBeTruthy();
            }
        }
    });
    ...
    test("language should have a name", () => {
        try {
            ...
            if (e instanceof Error) {            // console.log(checker.errors.map(err => err));
                expect(e.message).toBe(`checking errors (1).`);
                expect(checker.errors.includes("There should be a model in your language [file: test10.ast:1:1].")).toBeTruthy();
            }
        }
    });
    ...
    test("expression as base of concept", () => {
        try {
            ...
            if (e instanceof Error) {            // console.log(checker.errors.map(err => err));
                ...
                expect(checker.errors.includes("An entry with this part ('testUnit') already exists [file: test12.ast:6:5]."));
                expect(checker.errors.includes("A concept may not have an expression as base [file: test12.ast:12:33]."));
            }
        }
    });
});
