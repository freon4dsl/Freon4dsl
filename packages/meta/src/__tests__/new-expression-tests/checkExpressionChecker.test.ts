        ...
        if (!!language) {
            try {
                ...
                if (e instanceof Error) {
                    ...
                    expect(checker.errors.includes("Variable 'ff' should be known as property in classifier 'BB' [file: test-faulty1.fretest:5:5].")).toBeTruthy();
                    ...
                    expect(checker.errors.includes("Variable 'aap' should be known as property in classifier 'FF' [file: test-faulty1.fretest:20:25].")).toBeTruthy();
                    ...
                    expect(checker.errors.includes("Variable 'cc' should be known as property in classifier 'EE' [file: test-faulty1.fretest:28:8].")).toBeTruthy();
                    expect(checker.errors.includes("Variable 'peer' should be known as property in classifier 'Extra' [file: test-faulty1.fretest:32:18].")).toBeTruthy();
                }
            }
        }
    });
