...
export class FretVarCallExp extends FretExp {
    ...
    __variable: MetaElementReference<FretVarDecl>; // implementation of reference 'variable'
    ...
    set variable(newOne: FretVarDecl) {
        if (!!newOne) {
            this.__variable = MetaElementReference.create<FretVarDecl>(newOne, "FretVarDecl");
