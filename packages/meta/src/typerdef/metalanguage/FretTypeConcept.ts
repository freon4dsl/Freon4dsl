...
import { FreMetaConcept, FreMetaConceptProperty, FreMetaPrimitiveProperty, FreMetaPrimitiveType } from "../../languagedef/metalanguage/index.js";
...
export class FretTypeConcept extends FreMetaConcept {
    ...
    parts(): FreMetaConceptProperty[] {
        return this.properties.filter(prop => !(prop.type instanceof FreMetaPrimitiveType)) as FreMetaConceptProperty[];
    }
}
