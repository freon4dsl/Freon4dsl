...
import { KtList, Sentence, SpptDataNodeInfo } from 'net.akehurst.language-agl-processor';
...
import { FreTyperSyntaxAnalyser, ParsedNodeReference, PrimValueType } from './FreTyperSyntaxAnalyser.js';
