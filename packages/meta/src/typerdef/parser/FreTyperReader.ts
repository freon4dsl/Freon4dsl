...
import LanguageProcessor = net.net.akehurst.language.api.processor.LanguageProcessor;
import AutomatonKind_api = net.net.akehurst.language.api.processor.AutomatonKind_api;
