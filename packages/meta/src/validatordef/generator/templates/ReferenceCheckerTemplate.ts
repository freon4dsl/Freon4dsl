import { Names, PROJECTITCORE, LANGUAGE_GEN_FOLDER, PROJECTIT_GEN_FOLDER, LANGUAGE_UTILS_GEN_FOLDER } from "../../../utils";
...
export class ReferenceCheckerTemplate {
    ...
    generateChecker(language: PiLanguage, relativePath: string): string {
        ...
        import { ${environmentName} } from "${relativePath}${PROJECTIT_GEN_FOLDER}/${environmentName}";
