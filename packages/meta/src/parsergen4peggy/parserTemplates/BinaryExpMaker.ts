...
export class BinaryExpMaker {
    private static specialBinaryRuleName: string = `__fre_binary_`;
    public static getBinaryRuleName(expBase: FreMetaExpressionConcept) {
        return BinaryExpMaker.specialBinaryRuleName + expBase.name;
    }

    public static getNonBinaryRuleName(ruleName: FreMetaClassifier) {
        return '__fre_non_binary_' + ruleName.name;
    }
