...
import {
    ...
    MetaElementProperty,
    MetaElementType,
    MetaEnumeration, MetaEnumerationLiteral,
    MetaModel,
...
export class MetaProjection implements PiProjection {
    ...
    private createAttributeGrid(entity: MetaConcept): Box {
        ...
        cells.push({
            row: 1,
            column: 1,
            box: new LabelBox(entity, "properties-cell", "Properties", { style: styleClasses })
        });
        const grid = GridUtil.createCollectionRowGrid<MetaPrimitiveProperty>(
            ...
            [
                this.propertyNameBox,
                this.propertyTypeBox,
                this.propertyIsListBox,
                this.propertyIsOptionalBox],
        ...
        cells.push({
            row: 2, column: 1, box: grid
        });
        return new GridBox(entity, "attribute-grid", cells, { style: styles.indent });
    }

    propertyNameBox = (property: MetaPrimitiveProperty): Box => {
        return new TextBox(property, "textbox-name",
            () => property.name,
            (s: string) => property.name = s,
            {
    ...
    propertyIsListBox = (property: MetaPrimitiveProperty): Box => {
        return new SelectBox(property, "property-list",
            "<isList>",
    ...
    propertyIsOptionalBox = (property: MetaPrimitiveProperty): Box => {
        return new SelectBox(property, "property-optional",
            "<optional>",
            () => [{ id: "yes", label: "yes" }, { id: "no", label: "no" }],
            () => {
    ...
    propertyTypeBox = (property: MetaPrimitiveProperty): Box => {
        return new SelectBox(property, "property-type",
            "<type>",
            () => [{ id: "string", label: "string" }, { id: "boolean", label: "boolean" }, {
                id: "number",
                label: "number"
            }],
            () => {
    ...
    private createMetaElementBox(element: MetaConcept): Box {
        ...
        return new VerticalListBox(element, "meta-element-main", [
            ...
            new VerticalModelElementListBox(element, "parts",
                element.parts,
                "parts",
            ...
            new VerticalModelElementListBox(element, "references",
                element.references,
                "references",
                () => new MetaElementProperty(),
                this.editor,
    ...
    private createMetaModelBoxFullText(model: MetaModel): Box {
        ...
        return new VerticalListBox(model, "meta-model", [
            ...
            new VerticalModelElementListBox(model, "elements",
                model.elements,
                "elements",
                () => new MetaConcept(),
                this.editor,
    ...
    private createMetaModelBoxText(model: MetaModel): Box {
        ...
        return new VerticalListBox(model, "meta-model", [
            ...
            new LabelBox(model, "enumerations", "enumerations", {
                style: styles.keyword, selectable: false
            })
        ]);
    }
    ...
    private createPropertiesListBox(element: MetaConcept) {
        switch (this.projectionType) {
            ...
            case "text":
                return new VerticalModelElementListBox(element, "properties",
                    element.properties,
                    "properties",
    ...
    private createMetaEnumerationBox(enumeration: MetaEnumeration): Box {
        return new HorizontalListBox(enumeration, "meta-enumeration-main", [
            ...
            new VerticalModelElementListBox(enumeration, "literals",
    ...
    private createMetaPrimitivePropertyBox(property: MetaPrimitiveProperty): Box {
        return new HorizontalListBox(property, "meta-element-main", [
            ...
            PiProjectionUtil.booleanBox(property.type, "property-list", "isList", { yes: "list", no: "single" }),
    ...
    public createMetaElementPropertyBox(property: MetaElementProperty): Box {
        return new HorizontalListBox(property, "meta-element-property-main", [
            ...
            new SelectBox(property, "element-type",
                "<type>",
