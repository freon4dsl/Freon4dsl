...
<!-- todo check the hints, the enter key , for instance, does not work anymore -->
        ...
        <ul class="list-disc">
            ...
            <li class="ml-6 text-base border-none">Ctrl-UP selects the parent node in the AST</li>

            <li class="ml-6 text-base border-none">Ctrl-DOWN selects the first child node in the AST
            </li>
            <li class="ml-6 text-base border-none">Ctrl-SPACE shows popup menu of possible options
            </li>
            <li class="ml-6 text-base border-none">DEL deletes the next character or the currently selected
                item from the AST
            </li>
        </ul>
        </div>
