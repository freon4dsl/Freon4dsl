...
<!--&lt;!&ndash; Cannot get the onclick of Flowbite's ListgroupItem working, therefore I use a plain div, with plain buttons here.   &ndash;&gt;-->
...
<!--            Validate-->
<!--        </button>-->
<!--&lt;!&ndash;        <button type="button" onclick={EditorRequestsHandler.getInstance().interpret}&ndash;&gt;-->
<!--&lt;!&ndash;                class="flex items-center text-left py-2 px-4 w-full text-sm font-medium list-none first:rounded-t-lg last:rounded-b-lg hover:bg-gray-100 hover:text-primary-700 dark:hover:bg-gray-600 dark:hover:text-white focus:z-40 focus:outline-none focus:ring-2 focus:ring-primary-700 focus:text-primary-700 dark:focus:ring-gray-500 dark:focus:text-white flex"&ndash;&gt;-->
<!--&lt;!&ndash;                aria-current="false">&ndash;&gt;-->
<!--&lt;!&ndash;            <PlaySolid class="w-4 h-4 me-2 dark:text-white"/>&ndash;&gt;-->
<!--&lt;!&ndash;            Interpret&ndash;&gt;-->
<!--&lt;!&ndash;        </button>&ndash;&gt;-->
