...
This is a package that is used solely to start the Freon **Flowbite** webapp with one of the example languages
from packages/samples. 
The command 'npm run styles' generates the required css file for the webapp.
The command 'npm run dev' bundles the required packages and starts the webapp at port 8000.
