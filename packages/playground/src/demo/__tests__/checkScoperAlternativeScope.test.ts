...
import { DemoModel, DemoFunction, AppliedFeature, DemoAttributeRef } from "../language/gen";
...
describe("testing Alternative Scopes", () => {
    describe("testing IsInScope", () => {
        ...
        test("isInscope 'unitName' of 'Variable1.attrFromPerson.attrFromCompany', attrFromPerson: Company", () => {
            ...
            expect((model.functions[0].expression.appliedfeature.appliedfeature as DemoAttributeRef).attribute.name).toBe("attrFromCompany");
