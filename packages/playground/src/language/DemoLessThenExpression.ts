...
@model
export class DemoLessThenExpression extends DemoComparisonExpression implements PiBinaryExpression, WithType {
    readonly $type: LanguageConceptType = "DemoLessThenExpression";
