...
@model
export class DemoGreaterThenExpression extends DemoComparisonExpression implements PiBinaryExpression, WithType {
    readonly $type: LanguageConceptType = "DemoGreaterThenExpression";
