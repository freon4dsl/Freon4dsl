...
@model
export class DemoNumberLiteralExpression extends DemoLiteralExpression implements PiExpression, WithType {
    readonly $type: LanguageConceptType = "DemoNumberLiteralExpression";
