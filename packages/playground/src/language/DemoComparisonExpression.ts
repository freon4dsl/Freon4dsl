...
@model
export abstract class DemoComparisonExpression extends DemoBinaryExpression implements PiBinaryExpression, WithType {
    readonly $type: LanguageConceptType = "DemoComparisonExpression";
