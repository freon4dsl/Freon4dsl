...
@model
export class DemoDivideExpression extends DemoBinaryExpression implements PiBinaryExpression, WithType {
    readonly $type: LanguageConceptType = "DemoDivideExpression";
