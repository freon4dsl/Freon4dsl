...
import { DemoAttribute, DemoAttributeType, DemoModel, DemoEntity, DemoFunction, DemoVariable, PiElementReference } from "../language/gen";
...
export class CustomDemoProjection implements PiProjection {
    ...
    getBox(element: PiElement): Box {
        ...
        } else if (element instanceof DemoAttribute) {
