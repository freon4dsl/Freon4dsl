...
import { ExportedMetaModelEnvironment } from "../mps-test/environment/gen/ExportedMetaModelEnvironment";
export const editorEnvironment: PiEnvironment = ExportedMetaModelEnvironment.getInstance();
