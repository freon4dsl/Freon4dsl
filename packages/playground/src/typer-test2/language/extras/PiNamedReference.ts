 ...
 */
export class PiNamedReference<T extends PiNamedElement> extends PiReference<T> {
    /**
     ...
     * @param typeName
     */
    public static create<T extends PiNamedElement>(name: string | string[] | T, typeName: string): PiNamedReference<T> {
        const result = new PiNamedReference(null, typeName);
    ...
    private constructor(referredElement: T, typeName: string) {
        ...
        makeObservable<PiNamedReference<T>, "_PI_pathname" | "_PI_referred">(this, {
    ...
    get referred(): T {
        if (!!this._PI_referred) {
            ...
            return ProjectXEnvironment.getInstance().scoper.resolvePathName(
