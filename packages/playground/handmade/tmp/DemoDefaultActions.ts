...
export const EXPRESSION_CREATORS: PiExpressionCreator[] = [
    ...
    },
    {
        ...
        activeInBoxRoles: [EXPRESSION_PLACEHOLDER],
        expressionBuilder: (box: Box, trigger: PiTriggerType, editor: PiEditor) => {
            return new DemoNumberLiteralExpression();
        }
    },
    {
        trigger: "[TF]",
        activeInBoxRoles: [EXPRESSION_PLACEHOLDER],
        expressionBuilder: (box: Box, trigger: PiTriggerType, editor: PiEditor) => {
            return new DemoBooleanLiteralExpression();
        }
    },
    {
        trigger: "abs",
...
export const BINARY_EXPRESSION_CREATORS: PiBinaryExpressionCreator[] = [
    ...
    },
    {
        ...
        activeInBoxRoles: [LEFT_MOST, RIGHT_MOST, EXPRESSION_PLACEHOLDER, BEFORE_BINARY_OPERATOR, AFTER_BINARY_OPERATOR],
        expressionBuilder: (box: Box, trigger: PiTriggerType, editor: PiEditor) => {
            return new DemoLessThenExpression();
        },
        boxRoleToSelect: EXPRESSION_PLACEHOLDER
    },
    {
        ...
        activeInBoxRoles: [LEFT_MOST, RIGHT_MOST, EXPRESSION_PLACEHOLDER, BEFORE_BINARY_OPERATOR, AFTER_BINARY_OPERATOR],
        expressionBuilder: (box: Box, trigger: PiTriggerType, editor: PiEditor) => {
            return new DemoGreaterThenExpression();
        },
        boxRoleToSelect: EXPRESSION_PLACEHOLDER
    },
    {
        ...
        activeInBoxRoles: [LEFT_MOST, RIGHT_MOST, EXPRESSION_PLACEHOLDER, BEFORE_BINARY_OPERATOR, AFTER_BINARY_OPERATOR],
        expressionBuilder: (box: Box, trigger: PiTriggerType, editor: PiEditor) => {
            return new DemoEqualsExpression();
        },
        boxRoleToSelect: EXPRESSION_PLACEHOLDER
    }
];
