...
<style>
    ...
    .freon-switch {
        --mdc-theme-primary: var(--freon-boolean-switch-color, var(--mdc-theme-primary));
        --switch-track-color: color-mix(in srgb,var(--mdc-theme-primary),#fff 75%);
        --switch-hover-color: color-mix(in srgb,var(--mdc-theme-primary),#000 25%);
