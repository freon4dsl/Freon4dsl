/**
 * Class ShowCasePart is the implementation of the concept with the same name in the language definition file.
...
export class ShowCasePart extends FreNodeBaseImpl implements FreNamedNode {
     ...
     * @param data
     */
    static create(data: Partial<ShowCasePart>): ShowCasePart {
    ...
    readonly $typename: string = "ShowCasePart"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<ShowCasePart>): boolean {
