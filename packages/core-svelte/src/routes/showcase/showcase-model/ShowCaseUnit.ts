/**
 * Class ShowCaseUnit is the implementation of the model unit with the same name in the language definition file.
...
export class ShowCaseUnit extends FreNodeBaseImpl implements FreModelUnit {
     ...
     * @param data
     */
    static create(data: Partial<ShowCaseUnit>): ShowCaseUnit {
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<ShowCaseUnit>): boolean {
