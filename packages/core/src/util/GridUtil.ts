...
export class GridUtil {
  ...
  public static createCollectionRowGrid<ELEMENT_TYPE extends PiElement>(
    ...
    editor.keyboardActions.splice(
      0,
      0,
      this.createKeyboardShortcutForCollectionGrid<ELEMENT_TYPE>(
        element,
        role,
        builder
      )
   ...
   * @param roleToSelect
   */
  public static createKeyboardShortcutForCollectionGrid<
    ELEMENT_TYPE extends PiElement
  >(
    container: PiElement,
    ...
    const listKeyboardShortcut: KeyboardShortcutBehavior = {
      ...
      action: async (
        ...
        PiUtils.CHECK(
          parent[proc.propertyName][proc.propertyIndex] === element
        );
  ...
  public static createKeyboardShortcutForEmptyCollectionGrid<
    ELEMENT_TYPE extends PiElement
  >(
    container: PiElement,
    propertyRole: string,
