 ...
 */
@observer
export class SelectableComponent extends React.Component<
...
> {
  ...
  render() {
    ...
    if (isSelected) {
      if (
        isTextBox(selectedBox) ||
        isAliasBox(selectedBox) ||
        isSelectBox(selectedBox)
      ) {
    ...
    if (
      isTextBox(this.props.box) ||
      isAliasBox(this.props.box) ||
      isSelectBox(this.props.box)
    ) {
  ...
  onKeyDown = (e: React.KeyboardEvent<any>) => {
    ...
    if (
      PiUtils.handleKeyboardShortcut(
        reactToKey(e),
        this.props.box,
        this.props.editor
      )
