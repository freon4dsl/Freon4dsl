...
@observer
export class ProjectionalEditor extends React.Component<
  ProjectionalEditorProps,
  {}
> {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div
          className={STYLES.projectionalEditor}
          onBlur={this.onBlur}
  ...
  private role(): string {
    return !!this.props.editor.selectedBox
      ? this.props.editor.selectedBox.role
      : "no-box";
  }
