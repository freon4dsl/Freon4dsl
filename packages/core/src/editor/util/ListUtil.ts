...
export function getContextMenuOptions(
    ...
    const errorItem: MenuItem = new MenuItem(
        ...
        "",
        // @ts-ignore
        (node: FreNode, index: number, editor: FreEditor) => {},
    );
    ...
    if (optionsType === MenuOptionsType.placeholder) {
        ...
        items = [
            ...
            new MenuItem(
                ...
                "",
                // @ts-ignore
                (node: FreNode, index: number, editor: FreEditor) => console.log("this is not an option"),
            ),
            new MenuItem(
                "Cut",
                "",
            ...
            new MenuItem(
                ...
                "",
                // @ts-ignore
                (node: FreNode, index: number, editor: FreEditor) => copyListElement(node, editor),
            ),
            pasteBefore,
            pasteAfter,
        ];
