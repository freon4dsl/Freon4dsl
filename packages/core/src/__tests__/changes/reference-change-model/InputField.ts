...
import { MobxModelElementImpl, type FreNamedNode, observableprim } from "../../../ast/index.js";
import { FreUtils } from "../../../util/index.js";
import { FreParseLocation } from '../../../reader/index.js';
import { type INamedConcept } from "./internal.js";

import { makeObservable, action } from "mobx";

/**
 * Class InputField is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class InputField extends MobxModelElementImpl implements FreNamedNode, INamedConcept {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<InputField>): InputField {
        const result = new InputField(data.$id);
        if (!!data.name) {
    ...
    readonly $typename: string = "InputField"; // holds the metatype in the form of a string
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<InputField>): boolean {
