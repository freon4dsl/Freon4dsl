...
image::mapping-example-stringliteral.svg[mapping-example-stringliteral]
====
...
----
There are a large number of different types of boxes. See xref:meta-documentation/different-boxes.adoc[Boxes] for an overview.

Every projection must implement the xref:meta-documentation/interfaces.adoc[_PiProjection_] interface.
...
Actions are further described in xref:meta-documentation/defining_actions.adoc[Actions].
