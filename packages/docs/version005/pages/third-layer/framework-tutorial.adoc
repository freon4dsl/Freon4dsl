:page-title: ProjectIt Editor Customization
:page-nav_order: 60
...
= ProjectIt Editor Customization

As explained in xref:../intro/three-layers.adoc#tiers[Your Own Language - Overview] the five aspects of the generated workbench
