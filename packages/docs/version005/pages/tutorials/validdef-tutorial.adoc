...
As explained in xref:./first-language.adoc#tiers[Your Own Language - Overview] the generated validator can
be defined in three tiers.
...
The rest of this tutorial explains the second tier: how to write a validator definition (`.valid` file).
