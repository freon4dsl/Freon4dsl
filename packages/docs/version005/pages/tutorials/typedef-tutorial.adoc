...
indicate which concepts are considered to be types in your language. Note that the first concept in
the list is considered to be the root of your type hierarchy.
[source]
----
