...
= Editor Actions
The interaction of the user with the projected AST is done through actions, to enable the user to change the model and add elements to it. (All actions described here can be found in [green]#/demo/src/editor/TutorialProjection.ts#.)
