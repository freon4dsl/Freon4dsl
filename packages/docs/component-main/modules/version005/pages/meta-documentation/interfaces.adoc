...
[source]
----
include::{src-dir}/core/src/editor/PiProjection.ts[tag=PiProjection]
----
...
The box model is further described in the xref:meta-documentation/editor-framework.adoc[editor framework].
...
[source]
----
include::{src-dir}/core/src/validator/PiValidator.ts[tag=validator-interface]
----
