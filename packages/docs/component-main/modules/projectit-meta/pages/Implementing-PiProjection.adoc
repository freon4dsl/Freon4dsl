...
[source]
----
include::0.0.5@projectit-main:{src-dir}/core/src/language/PiProjection.ts[tag=PiProjection]
----
...
[source]
----
include::0.0.5@projectit-main:{src-dir}/core/src/language/PiModel.ts[tag=PiElement]
----
