import { AliasBox, Box, HorizontalListBox, LabelBox, NBSP } from "projectit";
...
export class GridUtil {
    ...
    public static createCollectionRowGrid<ELEMENT_TYPE extends PiElement>(
        ...
        editor: PiEditor,
        initializer?: Partial<GridBox>) : Box
    {
        ...
        columnNames.forEach( (item: string, index: number) => {
            cells.push({
                ...
                box: new LabelBox(element, "header"+ index, () => item,
                    { style: STYLES.headerText, selectable: false} ), style: STYLES.header});
        });
        ...
        editor.keyboardActions.splice(0,0,
