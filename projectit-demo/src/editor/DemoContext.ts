...
import { PiBinaryExpression, PiContext, PiExpression } from "projectit";
...
import {
    ...
    DemoExpression,
    DemoIfExpression,
    DemoNumberLiteralExpression, DemoOrExpression,
...
export class DemoContext implements PiContext {
    ...
    private initialize() {
        ...
        // const var1 = new DemoVariable("Variable1", entity1);
        // const var2 = new DemoVariable("VariableNumber2", entity2);
        // const var3 = new DemoVariable("Resultvar", entity1);
