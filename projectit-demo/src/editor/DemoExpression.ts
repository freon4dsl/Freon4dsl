 ...
 */
import { PiElement, PiExpression, PiBinaryExpression, PiContainerDescriptor } from "projectit";
...
DemoModelElement.prototype.piContainer = function() {
    return this.container
        ? { container: this.container, propertyName: this.propertyName!, propertyIndex: this.propertyIndex }
        : null;
};
